...
Patch other files (boot.img, firmwares) using patch file (.p) with "ApplyPatch"

## Note
### BlockImageUpdate was patched by our friend @rhn_1k and now it works for recent One UI builds

## Downloads
[Github Release](https://github.com/Filipemendonca1978/IMGPatchTools/releases)
